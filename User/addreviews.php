...
<body>
 ...
 Dear $username,  
   ...
   Your review for Booking ID $bid has been successfully submitted. 
    ...
    <form action="" method="POST" class="formcontainer">
        <div class="form-group">
            ...
            <div class="col-md-8 mx-auto">
                <img class="image " style="border-radius: 6px; height: 140px; width: 250px;" src="/projects/Car-Rental-System(EDI)/Cars/<?php echo $rws2['car_type']; ?>/<?php echo $rws2['image']; ?>">
            </div>
        </div>
        <div class="form-group">
