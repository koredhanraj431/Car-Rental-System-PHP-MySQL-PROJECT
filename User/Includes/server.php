...
if (isset($_POST['subscribe'])) {
    ...
    if ((filter_var($mail, FILTER_VALIDATE_EMAIL))) {
        ...
        $exist = "SELECT email_id FROM newsletter WHERE email_id='$mail'";

        if (mysqli_num_rows(mysqli_query($db, $exist)) > 0) {
            echo "<script type = \"text/javascript\">
                alert(\"Email already exists!\");
                </script>";
        } else {
            $qry = "INSERT INTO newsletter (email_id) values('$mail')";
 ...
 Thanks for Subscribing to our newsletters. You wil get our business news delivered straight into your inbox.
    ...
    Drive your Dreams!";
            ...
            $sender = "From: techwebbeast99@gmail.com";
            mail($mail, $subject, $message, $sender);
        }
    }
    else{
        echo "<script type = \"text/javascript\">
