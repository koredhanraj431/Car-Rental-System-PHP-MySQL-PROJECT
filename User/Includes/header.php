        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navitems" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link text-light" href="/projects/Car-Rental-System(EDI)/User/user.php">Home<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light" href="/projects/Car-Rental-System(EDI)/User/aboutus.php">About us</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light" href="/projects/Car-Rental-System(EDI)/User/contact.php">Contact us</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light" href="/projects/Car-Rental-System(EDI)/User/carvarieties.php">Explore cars</a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="/projects/Car-Rental-System(EDI)/User/post_testimonal.php">Post Testimonal</a>
                            <a class="dropdown-item" href="/projects/Car-Rental-System(EDI)/User/query.php">Queries</a>
