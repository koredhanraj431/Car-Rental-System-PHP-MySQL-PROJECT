...
<body>
  ...
  <div class="container" style="margin-top: 100px; margin-left: 28%;">
    <div class="row">
      <!-- edit form column -->
      <div class="col-md-9">
        <?php
        ...
        <h3 class="text-center text-secondary">
          Profile completion percentage : <?= $total ?>%
        </h3>
        <div style="background:red;border:1px solid;">
          <div style="color:green; width:<?= $total ?>%;background:green;">
            <?= $total ?>
          </div>
        </div>

        <h2 style="color:sienna; font-weight:bold;margin-top:30px">Personal Details</h3><br>
