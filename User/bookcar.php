...
<body>
	...
	if (isset($_POST['p2p'])) {
		...
		if (move_uploaded_file($_FILES['image']['tmp_name'], $target_path)) {
			...
			$amount = $days * $cost;
			$qry = "INSERT INTO clients (id,carid,pick_date,drop_date,days,username,doc_name,doc_type,status,amount)
			VALUES('$id','$carid','$pdate','$ddate','$days','$username','$doc_name','$doc_type','Pending','$amount')";
 ...
 Dear $username,  
   ...
   Drive your Dreams";
				...
				<form action="" class="form-horizontal" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-md-8 mx-auto">
							<img class="image " style="border-radius: 6px; height: 140px; width: 250px;" src="/projects/Car-Rental-System(EDI)/Cars/<?php echo $rws['car_type']; ?>/<?php echo $rws['image']; ?>"> </div>
					</div>
					<div class="form-group">
					...
					<br>
					<h4>Enter Booking Dates : </h4><br>

					<div class="form-group">
						<label class="col-md-3 control-label">Pick Up date : </label>
						<div class="col-md-8">
							<input class="form-control" type="date" id="pick_date" name="pick_date" placeholder="Start trip date" type="text" onchange="updatedate(), cal()" required>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-3 control-label">Drop off date : </label>
						<div class="col-md-8">
							<input class="form-control" type="date" id="drop_date" name="drop_date" placeholder="End trip date" type="text" onchange="cal()" required>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-3 control-label">Time-Span : </label>
						<div class="col-md-8">
							<input class="form-control" id="days" name="days" type="text" placeholder="(No of days car is required)" readonly>
						</div>
					</div>
	...
	<script>
		function updatedate() {
			var firstdate = document.getElementById("pick_date").value;
			document.getElementById("drop_date").value = "";
			document.getElementById("drop_date").setAttribute("min", firstdate);
		}
	</script>
