...
<meta charset="utf-8">
  ...
  <title>StandardSUV Domain</title>
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td> <img class="image" style="border-radius: 6px; height: 140px; width: 250px;" src="/projects/Car-Rental-System(EDI)/Cars/<?php echo $rws['car_type']; ?>/<?php echo $rws['image']; ?>" alt="">
            </td>
