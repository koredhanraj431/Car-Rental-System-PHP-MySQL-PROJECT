...
<body>
    ...
    $sel = "SELECT * FROM clients as t1 LEFT JOIN (SELECT * FROM clients WHERE username='$username')t2 ON t1.id = t2.id wHERE t2.status='Approved'";
    $rs1 = $dbh->query($sel);
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="vertical-align:middle;" align="center"> <img class="image" style="border-radius: 6px; height: 140px; width: 250px;" src="/projects/Car-Rental-System(EDI)/Cars/<?php echo $c_rws['car_type']; ?>/<?php echo $c_rws['image']; ?>" alt=""></td>

                            <form action="addreviews.php" method="POST">
                                <?php
                                $username = $_SESSION['username'];
                                $book_id=$rws['id'];
                                $qry = "SELECT * FROM reviews WHERE b_id='$book_id'";
                                $res = $dbh->query($qry);
                                if (mysqli_num_rows($res) > 0) { ?>
                                    <td style="vertical-align:middle" align="center">Reviewed</td>
                                <?php } else { ?>
