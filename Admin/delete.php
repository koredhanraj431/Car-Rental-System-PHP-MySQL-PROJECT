...
if(isset($_POST['del'])){
    ...
    $qr="DELETE FROM cars WHERE car_id = '$car_id'";
    mysqli_query($dbh, $qr);
    ...
    <form action="" class="form-horizontal form-container" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 mx-auto">
                    <button class="btn btn-dark btn-outline-danger" name="del" type="submit">Delete this Car</button><br><br>
                </div>
            </div>
    </form>
</body>
