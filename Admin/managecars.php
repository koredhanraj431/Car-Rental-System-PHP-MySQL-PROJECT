                    ...
                    <div class="btns">
                        <div>
                            <form action="modify.php" method="POST">
                                <button class="btn btn-dark btn-outline-success text-light" style="font-size: 15px; font-weight:bold" name="modify" value="<?php echo $rws['car_id']; ?>">Modify</button>
                            </form>
                        </div>
                        <div>
                            <form action="delete.php" method="POST" style="margin-top: 10px;">
                                <button type="submit" class="btn btn-dark btn-outline-danger text-light" style="font-size: 15px; font-weight:bold" name="delete" value="<?php echo $rws['car_id']; ?>">Delete</a>
                            </form>
                        </div>
                    </div>
