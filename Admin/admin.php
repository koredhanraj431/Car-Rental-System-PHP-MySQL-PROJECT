...
<div class="header">
	<h2>Welcome to Drive Your Dreams!</h2>
</div>
			...
			?>
				<tr>
					...
					<form action="userdetails.php" method="POST">
						<td style="vertical-align:middle" align="center"> <button class="btn btn-dark text-light btn-outline-success" style="font-size: 15px; font-weight:bold" type="submit" name="user_details" value="<?php echo $rows['id']; ?>">View Details</button>
					</form>
				</tr>
			<?php
			}
		...
		<table class="table">
			...
			?>
				<tr>
					...
					<?php if ($rws['status'] == 'Open') { ?>
						<form action="manageqrs.php" method="POST">
