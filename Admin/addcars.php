...
<body>
    ...
    <form action="" class="form-horizontal addcar" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8 mx-auto">
                <button type="submit" class="btn btn-dark btn-outline-success text-light" name="addcar">Add Car</button>
            </div>
        </div>
    </form>
    <?php
    if (isset($_POST['addcar'])) {
        ...
        if (move_uploaded_file($_FILES['image']['tmp_name'], $target_path)) {
            ...
            $car_name = mysqli_real_escape_string($dbh, $_POST['car_name']);
            $car_type = mysqli_real_escape_string($dbh, $_POST['car_type']);
            $hire_cost = mysqli_real_escape_string($dbh, $_POST['cost']);
            $capacity = mysqli_real_escape_string($dbh, $_POST['capacity']);
